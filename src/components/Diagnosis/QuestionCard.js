      ...
      <div className={styles.header}>
        <div className={styles.aboveProgressBarPart}>
          <div className={styles.userContainer}>
            <img className={styles.userIcon} alt="" src="/avatar2.svg" />
          ...
          <img
            ...
            alt=""
            src="/statedefault-sizel-themelight.svg"
          />
        </div>
        ...
        <div className={styles.radioOptions}>
          ...
          <div className={styles.multipleChoiceOtherChoice}>
            ...
            <img
              ...
              alt=""
              src="/statedefault-themelight-sizexs.svg"
            />
          </div>
        </div>
      </div>
      <div className={styles.footer}>
        <img className={styles.toldLogoIcon} alt="" src="/told-logo1.svg" />
